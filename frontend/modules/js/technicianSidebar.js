...
export function createTechnicianSidebar(activeRoute, onNavigate) {
    ...
    sidebar.innerHTML = `
        <div class="sidebar-mobile-header">
            <a class="brand" href="#technicianDashboard"><span class="brand-mark"><img src="/static/assets/images/logo.png?v=20260917c" alt="" aria-hidden="true"></span><div class="brand-text"><span class="brand-title">BusTrack</span><span class="brand-subtitle">Technician Portal</span></div></a>
