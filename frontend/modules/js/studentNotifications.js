...
export function render() {
    ...
    void Promise.all([request("/students/me"), request("/students/me/tracking"), request("/students/me/bus-pass")]).then(([student, tracking, passData]) => {
        ...
        (passData.alerts || []).forEach(alert => cards.unshift([alert.title, alert.message]));
